document.addEventListener("DOMContentLoaded", function() {
    ...
    const hotspotSteps = new Set(['step1','step2','step6']);
    ...
    const steps = [
        ...
        { id: 'step3', title: 'Adjust current', src: 'images/simulation/3.mp4', type: 'video' },
        { id: 'step4', title: 'Ignite arc', src: 'images/simulation/4.mp4', type: 'video' },
        { id: 'step5', title: 'Set torch angle and distance; move torch steadily across joint', src: 'images/simulation/5.mp4', type: 'video' },
