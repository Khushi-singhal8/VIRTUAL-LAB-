...
`;
    ...
    function isInteractiveStep(stepId) {
        return stepId === 'step1' || stepId === 'step1_5' || stepId === 'step2' || stepId === 'step3_1' || stepId === 'step3' || stepId === 'step4' || stepId === 'step4_5' || stepId === 'step5';
    }
    ...
    function renderResultStep() {
        ...
        gifContainer.innerHTML = `
            <div class="gif-wrapper print-area" style="overflow-y:auto; height:100%; display:block;">
                ...
                <div class="sim-media-container" style="max-width: 800px; margin: 20px auto;">
                    ...
                    <table style="border-collapse:collapse; width:100%; border:1px solid #000; font-family: sans-serif">
                        <tbody>
                            <tr>
